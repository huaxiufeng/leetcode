...
public class LC41FirstMissingPositive {
    ...
    /**
     ...
     2. If each cell in the array were to contain positive integers only, we can use the negative of the stored number as a flag to mark something (in this case the flag indicates this index was
    ...
    public static void main(String[] args) {
        LC41FirstMissingPositive solution = new LC41FirstMissingPositive();
